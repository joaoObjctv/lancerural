<div class="bannerApp bannerApp--top">
    <div class="container">
        <div class="d-grid">
            <img src="<?= get_template_directory_uri() . '/assets/img/mockup_cell 1.png'?>" alt="Imagem de um smartphone" />

            <div class="bannerApp__txt">
                <h2>A maior plataforma digital de pecuária do Brasil está ao seu alcance!</h2>
